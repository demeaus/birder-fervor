...
function Controls({ children }) {
  ...
  return (
    <div className="absolute z-20">
      <div
        className={`flex flex-col items-start gap-1 rounded-b-lg border-2 border-t-0 border-solid border-gray-400 bg-gray-700 px-2 py-2 pt-3 text-sm text-yellow-50 ${isOpen ? "" : "hidden "}`}
      >
